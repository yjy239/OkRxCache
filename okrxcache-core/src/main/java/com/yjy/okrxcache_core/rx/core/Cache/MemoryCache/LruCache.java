package com.yjy.okrxcache_core.rx.core.Cache.MemoryCache;
 ...
 *     time   : 2018/04/27
 *     desc   :the problem we cound't not force other to make the object serilation.so i have to make a change
 *     such as ,we only cache 100 request
 *     version: 1.0
 * </pre>
 */
